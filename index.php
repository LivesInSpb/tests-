...
/**
 * базовые конфигурации type - вид файла csv|xml , additional - дополнительные настройки для csv - разделитель, для xml -simple(теговый) или attribute(по атрибутам)
 */
$parseConfig = ["type" => "xml", "additional" => 'simple'];


/**
 * тут надо вставить текст для парсинга.
 */
